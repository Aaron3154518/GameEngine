...
struct Image {
   public:
    ...
    void draw(TextureBuilder& tex, Rect rect, RenderTextureCPtr data);
...
struct TextData {
    ...
    TextData& setImgs(const std::vector<RenderTextureCPtr>& imgs);
   ...
   private:
    ...
    std::vector<RenderTextureCPtr> mImgs;
